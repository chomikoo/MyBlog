...
<div id="comments" class="comments-area">
	...
	<h2 class="comments-title">
		...
		<?php 
				...
				printf(
					esc_html( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s komentarzy do &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'chomikootheme' ) ),
	...
	<?php chomikoo_get_post_navigation(); ?>
	...
	<?php if( !comments_open() && get_comments_number() ):?>
		...
		<p class="no-comments"><?php esc_html_e( 'Komentarze są zamknięte.', 'chomikotheme' ); ?></p>

	<?php endif; ?>

	<?php endif; ?><!-- have_coments -->
