...
add_action( 'wp_ajax_nopriv_chomikoo_load_more', 'chomikoo_load_more');
add_action( 'wp_ajax_chomikoo_load_more', 'chomikoo_load_more');
...
// 		echo '<div class="page-limit" data-page="' . $page_trail . 'page/' . $paged . '">';
// 		// echo 'page trail '. $page_trail . ' arch ' . $archive;
// 		while( $query->have_posts() ): $query->the_post();
