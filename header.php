...
<!-- wp head -->
	...
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo THEME_URL ?>favicon/apple-touch-icon.png">
	...
	<link rel="mask-icon" href="<?php echo THEME_URL ?>favicon/safari-pinned-tab.svg" color="#5bbad5">
